    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Burgers</h3>
                <p></p>
                <a href="login.php" class="btn" onclick="">Add to cart</a>
            </div>
        </div>
        <div class="box">
        ...
        <div class="box">
            <img src="images/Sushi-Burritos.jpg" alt="">
            <div class="content">
        ...
        <div class="box">
            <img src="images/Subway-Sandwich.jpg" alt="">
            <div class="content">
                <h3>Subway-Sandwich</h3>
                <p></p>
                <a href="login.php" class="btn" onclick="">Add to cart</a>
            </div>
        </div>
        <div class="box">
            <img src="images/Spicy-Noodles.jpg" alt="">
            <div class="content">
                <h3>Spicy-Noodles</h3>
                <p></p>
                <a href="login.php" class="btn" onclick="">Add to cart</a>
        ...
        <div class="box">
            <img src="images/Fruit-Juices.jpg" alt="">
            <div class="content">
                <h3>Fruit-Juices</h3>
                <p></p>
                <a href="login.php" class="btn" onclick="">Add to cart</a>
        ...
        <div class="box">
            <img src="images/Coconut-Water.jpg" alt="">
            <div class="content">
                <h3>Coconut-Water</h3>
                <p></p>
                <a href="login.php" class="btn" onclick="">Add to cart</a>
        ...
        <div class="box">
            <img src="images/Vegetable-Juices.jpg" alt="">
            <div class="content">
